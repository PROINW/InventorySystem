...
$page_title = 'แสดงใบเสร็จรับเงินและใบกำกับภาษี';
...
<head>
    ...
    <title>แสดงใบเสร็จรับเงิน/ใบกำกับภาษี</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div class="text-right">
            <button class="btn-primary" onclick="window.print()">พิมพ์ใบเสร็จรับเงิน / ใบกำกับภาษี</button>
        </div>

        <h1>ใบเสร็จรับเงิน / ใบกำกับภาษี (Tax Invoice)</h1>
        ...
        <div style="text-align: right;">
            <p>ราคาสินค้าทั้งหมดก่อนภาษีมูลค่าเพิ่ม: <?php echo number_format($quote['subtotal'], 2); ?> บาท</p>
            <p>ภาษีมูลค่าเพิ่ม 7%: <?php echo number_format($vat_amount, 2); ?> บาท</p>
            <p><strong>จำนวนเงินรวมทั้งสิ้น (รวมภาษีมูลค่าเพิ่ม): <?php echo number_format($total_with_vat, 2); ?> บาท</strong></p>
        </div>
        ...
        <!-- หมายเหตุ -->
        <div class="note-section">
            <strong>ผู้รับเงิน:บริษัท อาชีวะอุตสาหกรรม จำกัด</strong> <?php echo nl2br($quote['notes']); ?>
        </div>
</body>
